...
class JobScanResult(BaseModel):
    ...
    tools_and_tech: List[str] = Field(
        default_factory=list,
        description="Technologies, tools, or platforms mentioned"
    )
    keywords: List[str] = Field(
        default_factory=list,
        description="List of important skills and technologies from the job description that would appear on an ATS resume scan"
    )
...
class ResumeScanResult(BaseModel):
    ...
    work_experience_summary: Optional[str] = Field(
        None, description="Concise summary of work experience"
    )
    ...
    tools_and_tech: List[str] = Field(
        default_factory=list,
        description="Technologies, tools, frameworks, or platforms mentioned in the resume"
    )
    keywords: List[str] = Field(
        default_factory=list,
        description="List of important skills and technologies that would appear on an ATS resume scan"
    )
